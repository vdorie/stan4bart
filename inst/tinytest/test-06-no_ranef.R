# stan4bart with no random effects
...
# fit issues warning if overparameterized
...
# extract matches fitted in causal setting model for fixef only model
...
# extract matches as.array for fixef only model
arr <- as.array(fit)
