...
private:
        ...
        int is_binary;
        int prior_dist;
        int prior_dist_for_intercept; // 10
...
public:
      ...
      hs(hs)
    {
      num_params_r__ = 
        ...
        t + // tau
        (!is_binary ? 1 : 0); // + // aux_unscaled; transformed not part of num_params_r
        // (!is_binary ? 1 : 0) + // aux
        // K + // beta
        // q + // b
        // len_theta_L; // theta_L
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "is_binary", "int", context__.to_vec());
            is_binary = int(0);
            vals_i__ = context__.vals_i("is_binary");
            pos__ = 0;
            is_binary = vals_i__[pos__++];
            ...
            validate_non_negative_index("aux_unscaled", "logical_negation(is_binary)", logical_negation(is_binary));
            num_params_r__ += (1 * logical_negation(is_binary));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("aux_unscaled", "logical_negation(is_binary)", logical_negation(is_binary));
        context__.validate_dims("parameter initialization", "aux_unscaled", "double", context__.to_vec(logical_negation(is_binary)));
        std::vector<double> aux_unscaled(logical_negation(is_binary), double(0));
        size_t aux_unscaled_k_0_max__ = logical_negation(is_binary);
        for (size_t k_0__ = 0; k_0__ < aux_unscaled_k_0_max__; ++k_0__) {
            aux_unscaled[k_0__] = vals_r__[pos__++];
        }
        size_t aux_unscaled_i_0_max__ = logical_negation(is_binary);
...
template <bool propto__, bool jacobian__, typename T__>
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            size_t aux_unscaled_d_0_max__ = logical_negation(is_binary);
            ...
            validate_non_negative_index("aux", "logical_negation(is_binary)", logical_negation(is_binary));
            std::vector<local_scalar_t__> aux(logical_negation(is_binary), local_scalar_t__(0));
            ...
            if (as_bool(logical_negation(is_binary))) {

                current_statement_begin__ = 287;
                stan::model::assign(aux, 
                            stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                            (logical_eq(prior_dist_for_aux, 0) ? stan::math::promote_scalar<local_scalar_t__>(get_base1(aux_unscaled, 1, "aux_unscaled", 1)) : stan::math::promote_scalar<local_scalar_t__>((logical_lte(prior_dist_for_aux, 2) ? stan::math::promote_scalar<local_scalar_t__>(((prior_scale_for_aux * get_base1(aux_unscaled, 1, "aux_unscaled", 1)) + prior_mean_for_aux)) : stan::math::promote_scalar<local_scalar_t__>((prior_scale_for_aux * get_base1(aux_unscaled, 1, "aux_unscaled", 1))) )) ), 
            ...
            if (as_bool(logical_negation(is_binary))) {
                ...
                if (as_bool(logical_eq(prior_dist_for_aux, 0))) {
                    ...
                    stan::model::assign(aux, 
                                stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                get_base1(aux_unscaled, 1, "aux_unscaled", 1), 
                                "assigning variable aux");
                } else {
                    ...
                    stan::model::assign(aux, 
                                stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                (prior_scale_for_aux * get_base1(aux_unscaled, 1, "aux_unscaled", 1)), 
                                "assigning variable aux");
                    ...
                    if (as_bool(logical_lte(prior_dist_for_aux, 2))) {
                        ...
                        stan::model::assign(aux, 
                                    stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                                    (stan::model::rvalue(aux, stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), "aux") + prior_mean_for_aux), 
                                    "assigning variable aux");
                    }
                }
            ...
            current_statement_begin__ = 280;
            size_t aux_k_0_max__ = logical_negation(is_binary);
            for (size_t k_0__ = 0; k_0__ < aux_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(aux[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: aux" << "[" << k_0__ << "]";
            ...
            stan::math::fill(actual_aux, DUMMY_VAR__);
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(logical_negation(is_binary));
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(logical_negation(is_binary));
        dimss__.push_back(dims__);
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            current_statement_begin__ = 280;
            validate_non_negative_index("aux", "logical_negation(is_binary)", logical_negation(is_binary));
            std::vector<double> aux(logical_negation(is_binary), double(0));
            stan::math::initialize(aux, DUMMY_VAR__);
            stan::math::fill(aux, DUMMY_VAR__);
